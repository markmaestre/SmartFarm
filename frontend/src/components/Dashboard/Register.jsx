    ...
    try {
      ...
      if (res?.payload === 'User registered successfully') {
        Alert.alert(
          ...
          'Your SmartFarm account has been created successfully. Please login to continue.',
          [
            {
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Join the future of smart agriculture</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            >
              <LinearGradient
                colors={loading ? ['#66BB6A', '#66BB6A'] : ['#4CAF50', '#2E7D32']}
